...
MissingWOW64APIs=您正在运行的Windows版本不包含安装程序执行64位安装所需的功能。若要更正此问题，请安装Service Pack %1。
...
EntryAbortRetryIgnore=点击“重试”按钮重试，点击“忽略”继续，或点击“中止”取消安装。
...
; *** 文件复制错误
FileAbortRetryIgnore=点击“重试”重试，点击“忽略”跳过此文件（不推荐），或点击“中止”取消安装。
FileAbortRetryIgnore2=点击“重试”重试，点击“忽略”继续（不推荐），或点击“中止”取消安装。
SourceIsCorrupted=源文件已损坏
SourceDoesntExist=源文件“%1”不存在
ExistingFileReadOnly=现有文件被标记为只读。%n%n点击“重试”删除只读属性并重试，点击“忽略”跳过此文件，或点击“中止”取消安装。
ErrorReadingExistingDest=尝试读取现有文件时出错：
FileExists=文件已存在。%n%n是否要安装程序覆盖它？
ExistingFileNewer=现有文件比安装程序尝试安装的文件更新。建议您保留现有文件。%n%n是否保留现有文件？
